...
//        普通消息
        ...
        if($xml_arr['MsgType']=='text' && $xml_arr['Content']=="图片"){
            ...
            echo "<xml><ToUserName><![CDATA[".$xml_arr['FromUserName']."]]></ToUserName><FromUserName><![CDATA[".$xml_arr['ToUserName']."]]></FromUserName><CreateTime>".time()."</CreateTime><MsgType><![CDATA[image]]></MsgType><Voice><MediaId><![CDATA[".$msgs."]]></MediaId></Voice></xml>";
        }
    }
}